...
function displayMeals(meal) {
    ...
    for (let i = 0; i < meal.length; i++) {
        cartoona += `
        <div class="col-md-3">
                <div onclick="getMealDetails('${meal[i].idMeal}')" class="meal position-relative overflow-hidden rounded-2 pointer">
...
function displayCategories(meal) {
    ...
    for (let i = 0; i < meal.length; i++) {
        cartoona += `
        <div class="col-md-3">
                <div onclick="getCategoryMeals('${meal[i].strCategory}')" class="meal position-relative overflow-hidden rounded-2 pointer">
...
function displayArea(meal) {
    ...
    for (let i = 0; i < meal.length; i++) {
        cartoona += `
        <div class="col-md-3">
                <div onclick="getAreaMeals('${meal[i].strArea}')" class="rounded-2 text-center pointer area">
...
function displayIngredients(meal) {
    ...
    for (let i = 0; i < meal.length; i++) {
        cartoona += `
        <div class="col-md-3">
                <div onclick="getIngredientsMeals('${meal[i].strIngredient}')" class="rounded-2 text-center pointer ingred">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                ...
                <div id="emailAlert" class="alert alert-danger w-100 mt-2 d-none">
                    Email not valid *Omnia@gmail.com
                </div>
            </div>
            <div class="col-md-6">
...
/*  Validation*/
let nameInputcheck = false;
let emailInputcheck = false;
let phoneInputcheck = false;
let ageInputcheck = false;
let passwordInputcheck = false;
let repasswordInputcheck = false;
